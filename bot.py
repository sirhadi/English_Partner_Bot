...
در پایان یک سوال کوتاه بپرس، فقط متن نهایی رو بنویس و دقت کن که متن فارسی و انگلیسی تو خطوط مجزا باشند. از آیکون و ایموجی های رنگی که فرستادم در اول متنت هم استفاده کن.
"""
    try:
