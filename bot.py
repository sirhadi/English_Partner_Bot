...
def clean_text(text: str) -> str:
    # این الگوی اصلاح‌شده به تگ‌های HTML، حروف فارسی و انگلیسی، اعداد، ایموجی‌ها و علائم نگارشی اجازه عبور می‌دهد
  # و فقط کاراکترهای نامربوط غیرمتعارف (مثل چینی، سیریلیک و...) را حذف می‌کند
  pattern = (
      r"[^\u0000-\u007F\u0600-\u06FF\uFB50-\uFDFF\uFE70-\uFEFF\s<>iBb/=\"!?.,«»()"
