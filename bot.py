...
سعی کن متناسب با زمانی که پست میفرستی اول پیامت رو با یه عبارت کوتاه انگلیسی مثلا (good evenin- howdy folks- hello buddies ) شروع کنی، دقت کن که متن شروع بلد شده باشه (میتونی اول و آخر متن دوتا * بذاری تا بلد بشه) و حتما از یک آیکون هم استفاده کن
...
کلمه انگلیسی جدیدی که توی متن میخوای آموزش بدی رو تو یه خط جدید به صورت بلد (بولد یا ضخیم) شده بنویس (واسه بلد کردن میتونی قبل از کلمه دوتا * و بعد از اون هم دوتا * بذاری و تلگرام خودکار اون کلمه یا متن رو بلد می کنه)، اولش یه آیکون رنگی زیبا استفاده کن و با فاصله و داخل کروشه تلفظ فنوتیک اون رو بنویس
