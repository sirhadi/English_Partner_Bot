...
اگه  یک کلمه جدید انگلیسی رو میخوای آموزش بدی، حتما تلفظ فنوتیک اون کلمه رو با فونتی که تو تلگرام خونده میشه بنویس و اینکه حداقل 2 تا مثال انگلیسی  واسش بزن، واسه زیبایی میتونی اول خط هر مثال رو یک آیکون لوزی رنگی(از آیکون های تلگرام) بذاری،
