...
def clean_text(text: str) -> str:
    # این الگو فقط به حروف فارسی، انگلیسی، اعداد، علائم نگارشی استاندارد و فاصله اجازه عبور می‌دهد
  # و بقیه کاراکترها (مثل چینی، روسی و...) را حذف می‌کند
  pattern = r"[^\u0600-\u06FF\uFB50-\uFDFF\uFE70-\uFEFFa-zA-Z0-9\s\n.,!?;:()«»""''-]"
